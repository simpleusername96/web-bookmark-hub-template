...
웹페이지 원문 대신 URL과 메모·태그·미리보기를 로컬에 정리하고 다시 찾는 개인 자료함입니다.
이 저장소를 템플릿으로 삼아 Codex와 함께 필요한 기능을 골라 자신의 용도에 맞게 수정할 수 있습니다.

![저장한 자료를 살펴보는 자료함](docs/images/library-ko.png)
...
현재 자동 정리는 **Luna (`gpt-6-luna`) / reasoning effort `max`**를 사용합니다. 저장한 URL의 페이지 제목·본문·논문 초록 등에서 확인한 근거로 다음 기준을 적용합니다.
